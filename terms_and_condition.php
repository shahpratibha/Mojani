...
<h2 class="login-title">
    ...
    <form method="POST" onsubmit="return validateForm()" action="term_condition.php">
...
function validateForm() {
    ...
    if (checkBox.checked == true) {
        ...
        // window.location.href = "https://survey123.arcgis.com/share/252db72e41fb4b5db9df6204eae424ad?field:dept=Road&field:name=Aish";
        return true;
    } else {
        openModal();
        return false;
